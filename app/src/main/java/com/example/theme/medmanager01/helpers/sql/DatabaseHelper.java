...
import com.example.theme.medmanager01.helpers.model.User;
import com.example.theme.medmanager01.utils.ConversionOfDates;
import com.example.theme.medmanager01.utils.GetMonthValue;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_TABLE_MEDICATION = "CREATE TABLE " +MedicationContract.MedicationEntry.TABLE_NAME+"("+
                ...
                MedicationContract.MedicationEntry.COLUMN_MEDICATION_TIME+" TEXT NOT NULL,"+
    ...
    public int addMedication(Medication medication){
        ...
        cv_Medication.put(MedicationContract.MedicationEntry.COLUMN_MEDICATION_TIME, medication.getTime());
    ...
    public List<Medication> getAllMedications(){
        String columns [] = {
                ...
                MedicationContract.MedicationEntry.COLUMN_MEDICATION_TIME,
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                medication.setTime(cursor.getString(cursor.getColumnIndex(MedicationContract.MedicationEntry.COLUMN_MEDICATION_TIME)));
