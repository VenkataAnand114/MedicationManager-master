package com.example.theme.medmanager01.adapters;
...
import com.example.theme.medmanager01.utils.DatesDifferences;
import com.example.theme.medmanager01.views.MedicationCreationActivity;
import com.example.theme.medmanager01.views.MedicationDetailsActivity;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   /* Toast.makeText(v.getContext(),"Clicked Item"+listMedication.get(position).getName(),
                    ...
                    detailsActivityIntent.putExtra("interval",listMedication.get(position).getTime());
