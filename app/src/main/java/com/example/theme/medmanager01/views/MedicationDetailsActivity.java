...
import com.example.theme.medmanager01.utils.NotifyService;
...
public class MedicationDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date=bundle.getString("Interval");
        ...
        IntervalTextView.setText("You must take your medication at "+bundle.get("interval").toString() +" time" +
